        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <form action="index.php" method="post">
                <div class="flex items-center lg:order-2 justify-between ">
                    ...
                    <button class="ml-2 mt-1 px-2 py-2 bg-blue-700 text-white hover:bg-blue-800  shadow-sm border-slate-300  block w-full rounded-md text-xs focus:ring-1"><a href="registrarse.php">Registrarse</a></button>
            </form>
        </div>
